...
namespace ariel {
    ...
    class MagicalContainer::AscendingIterator {
        private:
            ...
            std::vector<int> sortedElements; // A sorted container with the container's elements
    ...
    class MagicalContainer::SideCrossIterator {
        ...
        public:
            ...
            SideCrossIterator(const MagicalContainer& cont, size_t l, size_t r, bool lToR = true);
